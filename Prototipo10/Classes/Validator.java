...
public class Validator {
	...
	public boolean validatePiece(LogicTable t, int turn, int l, int c) {
	...
	public boolean validatePosition(LogicTable t, int l, int c) {
	...
	public boolean validateMove(LogicTable t, int l, int c, int code) {
	...
	public boolean validateEat(LogicTable t, int l, int c, int code) {
