...
public class Validator {
	...
	public boolean validatePiece(TabuleiroLogico t, int turn, int l, int c) {
	...
	public boolean validatePosition(TabuleiroLogico t, int l, int c) {
	...
	public boolean validateMove(TabuleiroLogico t, int l, int c, int code) {
	...
	public boolean validateEat(TabuleiroLogico t, int l, int c, int code) {
	...
	public boolean limitedDirection(int l, int c){
