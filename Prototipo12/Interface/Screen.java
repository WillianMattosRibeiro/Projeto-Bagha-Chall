...
public class Screen extends JFrame{
	...
	public void initializeBoxButtons(){
		...
		int posx = (((int)getResolution().getWidth())/100)*64;
		int posy = (((int)getResolution().getHeight())/100)*85;
		
		menu.setBounds(posx, posy, 110, 40);
		exit.setBounds(posx+50*2, posy, 90, 40);
		
		menu.setIcon(new ImageIcon("res/menuButton.png"));
		menu.setRolloverIcon(new ImageIcon("res/menuButtonSelected.png"));
	...
	public void setPropriedades(){
		...
		setLayout(null);
		setTitle("Bagha Chall - (Beta Version - 0.0.11)");
