...
public class Tela extends JFrame{
	...
	public void inicializaComponentes(){
		...
		//INSTANCIA ANALISADOR
		analisador = new Analisador(matrizLogica);
		...
		if(turn == 1)
		{
			...
			else if(selecionados == 1)
			{
				...
				if(validador.validaPosicao(matrizLogica, p.getL(), p.getC()))
				{
					...
					else if(validador.validaComer(matrizLogica, origem, p) != null)
					{
						
						comerCabra(origem, p, validador.validaComer(matrizLogica, origem, p) );
						selecionados = 0;
						setTurn(2);
					}
	...
	public void comerCabra(Peça origem, Peça destino, Point cabra){
		
		matrizLogica.matrix[destino.getL()][destino.getC()] = matrizLogica.matrix[origem.getL()][origem.getC()];
		matrizLogica.matrix[origem.getL()][origem.getC()] = '0';
		matrizLogica.matrix[cabra.getLocation().x][cabra.getLocation().y] = '0';
