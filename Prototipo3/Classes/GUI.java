...
public class GUI {
	...
	JFrame frame;
	JPanel BoardPanel;
	public Table tabuleiro = new Table();
	...
	public void createGridButtons(){
		...
		for(int i = 0; i < 5; i++)
		{
			...
			{	
				...
				bMatrix[i][j].addActionListener(new ActionListener() {
	...
	public void setIcon(char m[][], int i, int j){
				if(m[i][j] == 'T')
				{
					bMatrix[i][j].setIcon(new ImageIcon("img/tiger.png"));
					bMatrix[i][j].setSelectedIcon(new ImageIcon("img/selectedTiger.png"));
				}
				else if(m[i][j] == 'G')
				{
					bMatrix[i][j].setIcon(new ImageIcon("img/goat.png"));
					bMatrix[i][j].setSelectedIcon(new ImageIcon("img/selectedgoat.png"));
				}
				else if(m[i][j] == '0')
				{
